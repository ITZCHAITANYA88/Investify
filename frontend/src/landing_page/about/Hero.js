  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5">
        <h3 className="text-center mt-5">We pioneered the discount broking model in India. <br></br>
        Now, we are breaking ground with our technology.</h3>
      </div>
      <div className="row p-5 mt-2 border-top text-muted fs-6" style={{lineHeight: "1.8", fontSize: "1.2em"}}>
