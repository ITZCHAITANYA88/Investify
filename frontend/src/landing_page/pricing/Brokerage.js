      ...
      <div className="row p-3 p-md-5 mt-5 text-center border-top">
        ...
        <div className="col-12 col-md-6 p-3 p-md-4">
          ...
          <ul
            ...
            style={{ textAlign: "left", lineHeight: "1.8", fontSize: "14px" }}
          >
            <li>Call & Trade and RMS auto-squareoff: ₹50 + GST per order</li>
            <li>Digital contract notes will be sent via e-mail</li>
            <li>Physical copies of contract notes: ₹20 per note + courier charges</li>
            <li>NRI Account (non-PIS): 0.5% or ₹100 per order (whichever is lower)</li>
            <li>NRI Account (PIS): 0.5% or ₹200 per order (whichever is lower)</li>
            <li>Orders with debit balance: ₹40 per order instead of ₹20</li>
          </ul>
        </div>
